  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const scoreData = {
        ...
        club: formData.club || "",
        userPhoto: selectedParticipant.photo || selectedParticipant.userPhoto || "",
      };
      ...
      {loading ? (
        ...
        <Box component="form" onSubmit={handleSubmit}>
          ...
          <TextField
            ...
            helperText="Optional: Enter the club or organization the participant belongs to"
          />
