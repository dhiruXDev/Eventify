          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-lg shadow p-6 border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold text-gray-800">My Club</h2>
                <svg className="w-8 h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                </svg>
              </div>
              <p className="text-gray-600 mb-4">Create or manage your club information, office details, and gallery.</p>
              <Link to="/profile" className="inline-block bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 rounded-md transition duration-300">
                Manage Club
              </Link>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6 border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 mb-4">Manage club recruitments, set up online exams, and shortlist candidates.</p>
              <div className="flex flex-col gap-2">
                <Link to="/recruitment/create" className="text-center bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded-md transition duration-300 font-medium">
                  Create Recruitment
                </Link>
                <Link to="/recruitment/manage" className="text-center border border-indigo-600 text-indigo-600 hover:bg-indigo-50 py-2 px-4 rounded-md transition duration-300 font-medium">
                  Manage Recruitment
                </Link>
              </div>
            </div>
