...
exports.updateUserSettings = async (req, res, next) => {
  try {
    ...
    if (!userSettings) {
      ...
      if (req.body.interestedClubs !== undefined) userSettings.interestedClubs = req.body.interestedClubs;
...
/**
 * @desc    Get all user settings (for internal use by other services)
 * @route   GET /api/settings/all-users
 * @access  Private (Internal service calls only)
 */
exports.getAllUserSettings = async (req, res, next) => {
  try {
